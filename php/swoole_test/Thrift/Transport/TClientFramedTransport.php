 ...
 * @package thrift.transport
 */
class TClientFramedTransport extends TTransport
{
  /**
  ...
  public function flush()
  {
    ...
    $tmp_out = pack('N', TStringFuncFactory::create()->strlen($this->wBuf_));
    $tmp_out .= $this->wBuf_;
    $out = pack('N', TStringFuncFactory::create()->strlen($tmp_out));
    $out .= $tmp_out;
  ...
  public function getOutput() {
    return $this->transport_->getOutput();
  }
