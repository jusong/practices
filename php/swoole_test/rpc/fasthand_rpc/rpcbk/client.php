...
try {
	...
	$fasthandUser = new User\FasthandUser($userInfo);
	$userClient->storeUser($fasthandUser);
	...
	$fasthandArticle = new Article\FasthandArticle($articleInfo);
	$articleClient->storeArticle($fasthandArticle);
