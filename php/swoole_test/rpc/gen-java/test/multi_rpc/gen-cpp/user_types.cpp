...
void User::__set_age(const int8_t val) {
  this->age = val;
}
...
uint32_t User::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("age", ::apache::thrift::protocol::T_BYTE, 3);
  xfer += oprot->writeByte(this->age);
  xfer += oprot->writeFieldEnd();
